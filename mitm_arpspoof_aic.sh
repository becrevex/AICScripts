...
if [ $# == 0 ] ; then
    echo -e "${GREEN}"
    echo -e "Description:"
    echo -e "Successful execution will ARP spoof the provided"
    echo -e "the target on the interface provided. The default"
    echo -e "gateway is automatically configured."
    echo -e ""
